...
// ==========================================================================
			...
			else
			{
				...
				show_boiler_state('FAKEL_K1', data['FAKEL_K1'], data['K1Z_F302'], '35');
				show_boiler_state('FAKEL_K2', data['FAKEL_K2'], data['K2_F1_para_za_k'],data['K2_F_pit_v']);
				show_boiler_state('FAKEL_K3', data['FAKEL_K3'], data['K3_3NFC201_10'], '35');
				show_boiler_state('FAKEL_K4', data['FAKEL_K4'], '35', '35'); //расход ложный для К-4
				show_boiler_state('FAKEL_K5', data['FAKEL_K5'], Number(data['K5_FQ2'])+Number(data['K5_FQ3']), '35');
